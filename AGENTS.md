...
完成标准：任务库校验通过、测试通过、`exports/graph.mmd`、`exports/graph.dot`、`exports/tasks.md`、`exports/graph.html`、`exports/scoreboard.html` 全部已重新生成，并且没有遗漏任何由任务图或成长计分规则变化触发的依赖产物。
